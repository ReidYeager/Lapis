#ifndef LAPIS_EVENT_WINDOW_H
#define LAPIS_EVENT_WINDOW_H
...
{
public:
  EVENT_DEFINE_COMMON(Event_Window_Close, Event_Category_Window)
  EventWindowClose() {}
...
{
public:
  EVENT_DEFINE_COMMON(Event_Window_Resize, Event_Category_Window)
...
{
public:
  EVENT_DEFINE_COMMON(Event_Window_Minimize, Event_Category_Window)
...
{
public:
  EVENT_DEFINE_COMMON(Event_Window_Move, Event_Category_Window)
...
{
public:
  EVENT_DEFINE_COMMON(Event_Window_Focus, Event_Category_Window)
